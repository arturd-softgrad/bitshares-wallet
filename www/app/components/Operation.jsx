...
class Operation extends React.Component {
                ...
                // } else {
                    /*column = (
                        <span key={"transfer_" + this.props.key} className="right-td">
                            ...
                            &nbsp;<Translate component="span" content="wallet.transaction_sent"/>
                            &nbsp;<FormattedAsset style={{fontWeight: "bold"}} amount={op[1].amount.amount} asset={op[1].amount.asset_id}/>
                            &nbsp;<Translate component="span" content="wallet.transaction_to"/> {this.linkToAccount(op[1].to)}
                            {memo_text ? <div className="memo">{memo_text}</div> : null}
                        </span>
                    );*/
  ...
  //<ValueComponent amount={amount} quoteAsset={assetId} baseAsset={"1.3.0"}/>
                    ...
                    let amount = isSent? - op[1].amount.amount : op[1].amount.amount;

                    let sentRcvd = (this.props.rowid || 0) == 0 ?
                        [<span className="tran-sent">|<Translate component="span" content='wallet.home.sent'/>|</span>
                        ,<br/>,
                    ...
                    //console.log("$$$operations transfer op[1]=", op[1]); // $$$
                // }
            ...
            case "account_create":
                if (current === op[1].registrar) {
                    ...
                    column = (
                        <span>
                            {op[1].name}
                            &nbsp;<Translate component="span" content="wallet.was_reg_account" />
                            &nbsp;{op[1].registrar}
                        </span>
                    );
                }
            ...
            case "account_transfer":
                column = (
                    <span>
                        ...
                        <Translate component="span" content="wallet.transaction_to" />
                ...
                if (current === op[1].lender) {
                    ...
                    column = (
                        <span>
                            <Translate component="span" content="transaction.bond_accept_offer" />
                            &nbsp;<FormattedAsset style={{fontWeight: "bold"}} amount={op[1].amount_borrowed.amount} asset={op[1].amount_borrowed.asset_id} />
                            <Translate component="span" content="wallet.transaction_from" />
