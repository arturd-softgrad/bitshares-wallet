...
static md5(s)
{
  ...
  shouldComponentUpdate(nextProps) {
      ...
      nextProps.size.width !== this.props.size.width || nextProps.account !== this.props.account ||
  ...
  repaint()
  {
        ...
        if (email && email.length!=0)
        {
            ...
            xhr.open('GET', "http://www.gravatar.com/avatar/"+hash, true);
